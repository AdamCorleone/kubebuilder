...
//+kubebuilder:rbac:groups=ingress.zyb.tech,resources=apps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ingress.zyb.tech,resources=apps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ingress.zyb.tech,resources=apps/finalizers,verbs=update
	...
	if err := r.Get(ctx, req.NamespacedName, d); err != nil {
		if errors.IsNotFound(err) {
			if err := r.Create(ctx, deployment); err != nil {
				logger.Error(err, "crete deploy failed")
				return ctrl.Result{}, err
			}
		} else {
